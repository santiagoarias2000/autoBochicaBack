...
const sql_update_1 = require("./../../repo/person/sql_update");
const Update_1 = __importDefault(require("../../dao/person/Update"));
class PersonControllerUpdate extends Update_1.default {
    updatePerson(req, res) {
        ...
        PersonControllerUpdate.updatePerson(sql_update_1.SQL_PERSON_UPDATE.UPDATE, parameter, res);
    }
}
