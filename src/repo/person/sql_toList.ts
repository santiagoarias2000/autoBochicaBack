export const SQL_PERSON_VIEW={
    VIEW:"select first_name, second_name, first_last_name, second_last_name, mail, birthdat, direction, phone_number, occupation, numbers, issued_in, tsdo.type_document, stsscer.state_certificate, value_receipt, photo, photo_fingerprint, date_tuition,vhi.license_plate,tuis.name_tuition,cou.name_course, cou.time_course,tg.type_gender,ts.type, ts.rh, stra.name_stractum, sis.name_sisben, cs.type_civil_status,el.name_education_level, ci.name_city \
    from persons ps\
